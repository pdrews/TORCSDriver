...
settings.setParameter('initSigma', 2);
settings.setParameter('initSigmaMu', 0.0); 
...
settings.setParameter('numIterations',2000);
...
dimState = 7; %TODO: set this for TORCS
dimAction = 6;
...
[resultsCellCell, trialsCellCell, propertiesCell] = evalFunc({'epsilonAction'}, {0.3;0.5;0.8});
